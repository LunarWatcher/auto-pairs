    ...
    if b:AutoPairsMapCR
        ...
        elseif has("nvim") && !has_key("rhs")
            echoerr "Life is a d100, and you rolled -70000. Neovim has broken compatibility with Vim by removing `rhs` from the maparg function"
                        ...
                        \ "This keybind results in rhs not being populated. Due to the way auto-pairs is designed, including a funcref in the"
                        \ "mapping is not an option that can be trivially done. This would've been easier if auto-pairs was designed for neovim, but it isn't."
                        \ "Both this fork and the original were designed for Vim. While there are things in place to help with nvim compatibility,"
                        ...
                        \ "that's now breaking support in stable functions, is not sustainable work-wise."
